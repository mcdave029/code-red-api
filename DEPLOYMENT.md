...
sudo service unicorn_code_red_api <start|stop|restart>
sudo service sidekiq_code_red_api <start|stop>
```
...
```
/home/deployer/apps/code_red_api/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_code_red_api restart
sudo service sidekiq_code_red_api stop
sudo service sidekiq_code_red_api start
```
